 ...
 */
final class Version20220924184317 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE badge (id INT AUTO_INCREMENT NOT NULL, name LONGTEXT NOT NULL, image LONGTEXT NOT NULL, description LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE contact (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, type_contact_id INT DEFAULT NULL, phone VARCHAR(20) DEFAULT NULL, description LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_4C62E638A76ED395 (user_id), INDEX IDX_4C62E638FAA2F36F (type_contact_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE course_part (id INT AUTO_INCREMENT NOT NULL, course_section_id INT DEFAULT NULL, title LONGTEXT NOT NULL, order_part INT NOT NULL, estimated_time INT NOT NULL, INDEX IDX_81ADADC07C1ADF9 (course_section_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE course_part_document (id INT AUTO_INCREMENT NOT NULL, course_part_id INT DEFAULT NULL, link_video LONGTEXT DEFAULT NULL, content LONGTEXT NOT NULL, files LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_8CB64BD044204E00 (course_part_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE course_part_quiz (id INT AUTO_INCREMENT NOT NULL, quiz_id INT DEFAULT NULL, course_part_id INT DEFAULT NULL, INDEX IDX_5C1BC4B3853CD175 (quiz_id), UNIQUE INDEX UNIQ_5C1BC4B344204E00 (course_part_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE course_section (id INT AUTO_INCREMENT NOT NULL, course_id INT DEFAULT NULL, name LONGTEXT NOT NULL, course_order INT NOT NULL, INDEX IDX_25B07F03591CC992 (course_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE quiz (id INT AUTO_INCREMENT NOT NULL, speaker_id INT DEFAULT NULL, description LONGTEXT NOT NULL, public TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, time_to_perform_all INT NOT NULL, title VARCHAR(255) NOT NULL, theme VARCHAR(255) NOT NULL, INDEX IDX_A412FA92D04A0F27 (speaker_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, name LONGTEXT NOT NULL, firstname LONGTEXT NOT NULL, image LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, activated TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE course_part_document ADD CONSTRAINT FK_8CB64BD044204E00 FOREIGN KEY (course_part_id) REFERENCES course_part (id)');
        $this->addSql('ALTER TABLE course_part_quiz ADD CONSTRAINT FK_5C1BC4B3853CD175 FOREIGN KEY (quiz_id) REFERENCES quiz (id)');
        $this->addSql('ALTER TABLE course_part_quiz ADD CONSTRAINT FK_5C1BC4B344204E00 FOREIGN KEY (course_part_id) REFERENCES course_part (id)');
        ...
        $this->addSql('ALTER TABLE quiz ADD CONSTRAINT FK_A412FA92D04A0F27 FOREIGN KEY (speaker_id) REFERENCES speaker (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE course_part_document DROP FOREIGN KEY FK_8CB64BD044204E00');
        ...
        $this->addSql('ALTER TABLE quiz DROP FOREIGN KEY FK_A412FA92D04A0F27');
