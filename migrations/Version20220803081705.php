 ...
 */
final class Version20220803081705 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE course_part_document (id INT AUTO_INCREMENT NOT NULL, link_video LONGTEXT DEFAULT NULL, content LONGTEXT NOT NULL, files LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
